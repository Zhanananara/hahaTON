...
const ProdList = () => {
  ...
  // чтобы в самом начале рождения компенента установить query params == параметры запроса и именно по ним делать запрос getProducts()
  useEffect(() => {
    setSearchParams({
  ...
  return (
    ...
    textAlign: "center"
      ...
      color="secondary" sx={{display: "inline-block"}}
